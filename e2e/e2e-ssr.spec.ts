...
const createTest = (SSR_SERVER_URL: string) => {
  test.describe(`SSR E2E: 서버사이드 렌더링 쇼핑몰 테스트 (${SSR_SERVER_URL})`, () => {
...
createTest(`http://localhost:4174/front_6th_chapter4-1/vanilla/`);
createTest(`http://localhost:4176/front_6th_chapter4-1/react/`);
