...
import { filterProducts, getUniqueCategories, paginateProducts, items } from "../mocks/shared.js";
import { hasHomePageData } from "../utils";
...
export const getServerSideProps = async (context) => {
  ...
  const filtered = filterProducts(items, normalizedQuery);
  const pageProducts = paginateProducts(filtered, page, limit);
