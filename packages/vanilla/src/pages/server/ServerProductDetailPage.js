...
/**
 * 상품 상세 컴포넌트 (ProductDetailPage.js에서 추출한 순수 함수)
 */
...
/**
 * 서버 사이드 렌더링을 위한 ProductDetailPage 컴포넌트
 * withLifecycle 없이 순수한 렌더링 함수로 구현
 *
 * @param {Object} props - 렌더링에 필요한 데이터
 * @param {Object} props.product - 상품 상세 정보
 * @param {Array} props.relatedProducts - 관련 상품 목록
 */
export function ServerProductDetailPage({ product, relatedProducts = [] }) {
  // 에러 처리 - 상품이 없는 경우
  if (!product) {
      ...
      children: `
        <div class="min-h-screen bg-gray-50 flex items-center justify-center">
          <div class="text-center">
            ...
            <p class="text-gray-600 mb-4">요청하신 상품이 존재하지 않습니다.</p>
            <button onclick="window.history.back()" 
