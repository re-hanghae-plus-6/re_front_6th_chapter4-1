...
export const ProductDetailPageSSR = ({ initialData = {} }) => {
  return PageWrapper({
    ...
    `.trim(),
    children:
      initialData.error && !initialData.currentProduct
        ? ErrorContent({ error: initialData.error })
        : ProductDetail({ product: initialData.currentProduct, relatedProducts: initialData.relatedProducts }),
  });
};
